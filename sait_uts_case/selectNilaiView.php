            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="scroll">
                        ...
                        curl_setopt($curl, CURLOPT_URL, 'http://localhost/sait_uts_api/sait_api.php');
                        $res = curl_exec($curl);
                        ...
                        echo '<table class="table table-bordered table-striped">';
                            ...
                            for ($i = 0; $i < count($json["data"]); $i++) {
                                echo "<tr>";
                                    ...
                                    echo '<a href="updateNilaiView.php?nim='.$json["data"][$i]["nim"].'&kode_mk='.$json["data"][$i]["kode_mk"].'" title="Update Record" data-toggle="tooltip"><span class="fa fa-pencil""></span></a>';
                                    echo "</td>";
                                echo "</tr>";
                            }
                            echo "</tbody>";                            
